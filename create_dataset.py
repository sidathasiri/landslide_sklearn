...
inputData = pd.concat([slope_data, landform_data, landuse_data, vegetation_data, drainage_density_data, overburden_data, catchment_area_data], axis=1)
#inputData = normalize(inputData)
#inputData = pd.DataFrame(inputData, columns=["slope", "landform", "landuse", "vegetation"])
# print("input\n", inputData.head())

inputData.columns = ["slope", "landform", "landuse", "vegetation", "drainage", "overburden", "catchment_area"]
